<template>
	<view class="tui-container">
		<view class="tui-upload-box">
			...
			<view class="tui-image-item" v-if="src">
				<view class="video_close" @tap="delectVideo">x</view>
				<video :src="src" class="video"></video>
			</view>


			<view v-if="isShowAdd&&!src" class="tui-upload-add" @tap="chooseImageOrVideo">
				<view class="add">
					<view class="quan">
						<image src="../../static/bao/add.png"></image>
					</view>
					<view class="img">添加图片</view>
				</view>
			</view>
		</view>
	</view>
...
<script>
	export default {
		...
		methods: {
			chooseImageOrVideo() { //点击加号选择添加图片或视频
			...
			uploadVideo: function(index, url) {
				let _this = this;
							...
							if (res.statusCode == 200) {
								...
								if (d.code == 1) {
									...
									_this.$emit('complete', {
										...
										video: "https://xin.yiyunoto.com" + d.data
									})
									// 上传成功 d.url 为上传后图片地址，以实际接口返回为准
									// d.data && (_this.imageList[index] = "https://xin.yiyunoto.com" + d.data)
