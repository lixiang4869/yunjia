	...
	<view class="content" :style="{width:width,height:height}">
		...
		top: 0;left: 0;">
			...
			<view class="cityhhren">
				<view class="title">申请成为黑卡会员</view>
				<view class="phone" style="margin-top:30rpx ;">
					<view>推荐人手机号</view>
					<input type="text" placeholder="请输入手机号" v-model="phone" style="margin-left: 30rpx;" @input="getInfoByPhone" >
				</view>
				<view class="phone" >
					<view >推荐人ID</view>
			...
			<!-- <view class="phone2"> -->
				<!-- <input type="text" placeholder="请输入社区名称"  v-model="community" @input="getValue"> -->
		...
		<mpvue-city-picker :themeColor="themeColor" ref="mpvueCityPicker"  :isShowQi="true"  :pickerValueDefault="cityPickerValue"  @onChange="onConfirm"  @onCancel="onCancel"
...
<script>
	...
	export default {
		...
		methods: {
			...
			goXieYi(){
			uni.navigateTo({
				url:"../../xieyi/image?title=黑卡合伙人协议&src="+"https://xin.yiyunoto.com/black.png"
			})
