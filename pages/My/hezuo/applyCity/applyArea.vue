<template>
	<view class="content" :style="{width:width,height:height}">
		...
		<view class="cityhhren">
			<view class="title">申请成为区域合伙人</view>
		...
		<mpvue-city-picker :themeColor="themeColor" ref="mpvueCityPicker" :isShowArea="true" :isShowQi="true" :pickerValueDefault="cityPickerValue"  @onChange="onConfirm" @onCancel="onCancel" @onConfirm="onConfirm"  @change="onConfirm"></mpvue-city-picker>
...
<script>
	...
	export default {
		...
		methods: {
			...
			goXieYi(){
			uni.navigateTo({
				url:"../../xieyi/image?title=区域合伙人协议&src="+"https://xin.yiyunoto.com/area.png"
			})
